...
const section3Contents = [
  {
    ...
    title: "PREMIUM 01",
    text1: `829세대 브랜드 프리미엄`,
    text2: `서산 예천동 중심에 들어서는<br />
			      대규모 프리미엄 브랜드 단지`,
  ...
  },
  {
    ...
    title: "PREMIUM 02",
    text1: `예천동 신흥 주거벨트 입지`,
    text2: `서산 중심 생활권을 누리는<br />
			      편리한 도심 인프라`,
        ...
        <>
          ...
          <div className={styles.imageContainer}>
            ...
            <div className={styles.mainImageTextSub}>
              ...
              품격 있는 라이프스타일
              <span className={styles.greyText}> 트리븐 서산</span>
            </div>
            ...
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                <div className={styles.text3}>
                  - 서산 예천동 중심 생활권에서 누리는 프리미엄 라이프<br />
                  - 교통·생활·교육 인프라를 가까이 누리는 편리한 주거 환경<br />
                  - 남향 위주 배치와 판상형 중심 설계로 쾌적한 주거 공간<br />
                  - 피트니스·골프연습장·북카페 등 다양한 커뮤니티 시설<br />
                  - 829세대 브랜드 프리미엄 단지로 기대되는 미래 가치
                </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img
                  src={section4_Image1}
                  alt="트리븐 서산 브랜드소개-image4"
                />
                <div className={styles.text1}>트리븐 서산</div>
          ...
          <div className={styles.pcVisitContainer}>
            ...
            <form
              ...
              action="https://formspree.io/f/mojprnjb"
              method="POST"
            >
              <label htmlFor="name">
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="트리븐 서산 오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.imageContainer}>
            ...
            <div className={styles.mainImageTextSub1}>
              ...
              새로운 주거 기준을 제시하는
              <br />
              <span className={styles.greyText1}>트리븐 서산</span>
            </div>
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 트리븐 서산에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="트리븐 서산 모바일 조감도 이미지"
            />
          </div>
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="트리븐 서산 브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="트리븐 서산 오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
